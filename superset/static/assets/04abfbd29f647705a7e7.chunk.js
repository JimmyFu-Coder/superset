...
`,_t=(0,o.t)("Datasets can be created from database tables or SQL queries. Select a database table to the left or "),St=(0,o.t)("create dataset from SQL query"),Tt=(0,o.t)(" to open SQL Lab. From there you can save the query as a dataset."),kt=(0,o.t)("Select dataset source"),Ct=(0,o.t)("No table columns"),Et=(0,o.t)("This database table does not contain any data. Please select a different table."),It=(0,o.t)("An Error Occurred"),Pt=(0,o.t)("Unable to load columns for the selected table. Please select a different table."),Kt=t=>{const{hasError:e,tableName:n,hasColumns:i}=t;let l="empty-dataset.svg",o=kt,r=(0,v.tZ)(a.Fragment,null,_t,(0,v.tZ)(j.rU,{to:"/sqllab"},(0,v.tZ)("span",{role:"button",tabIndex:0},St)),Tt);return e?(o=It,r=(0,v.tZ)(a.Fragment,null,Pt),l=void 0):n&&!i&&(l="no-columns.svg",o=Ct,r=(0,v.tZ)(a.Fragment,null,Et)),(0,v.tZ)(Ut,null,(0,v.tZ)(zt,{image:l,title:o,description:r}))};var Dt;!function(t){t.ABSOLUTE="absolute",t.RELATIVE="relative"}(Dt||(Dt={}));const Mt=f.iK.div`
